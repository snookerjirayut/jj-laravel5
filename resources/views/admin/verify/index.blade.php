	   		...
	   		<div class="col-sm-12">
	   			<table class="table table-striped table-bordered">
	   				<thead>
	   					<tr>
	   						<td  width="5%">ลำดับ</td>
	   						<td  width="20%">สมาชิก</td>
	   						<td  width="20%">ล็อคที่อง</td>
	   						<td  width="5%" class="text-center">เช็คอิน</td>
	   						<td  width="5%" class="text-center">ประเภทการชำระ</td>
	   						<td  width="5%" class="text-center">สถานะการชำระ</td>
	   						<td  width="5%" class="text-center">สถานะตรวจสอบ</td>
	   						<td  width="5%" class="text-center">ตรวจสอบ</td>
	   					</tr>
	   				</thead>
	   				<tbody>
